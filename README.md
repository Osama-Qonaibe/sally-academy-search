# Sally Academy Search

محرك بحث ذكي مدعوم بالذكاء الاصطناعي لأكاديمية سالي
...
- Alternative providers:
  ...
  - [Firecrawl](https://firecrawl.dev/) - Web, news, and image search with crawling, scraping, LLM-ready extraction
...
```bash
git clone git@github.com:[YOUR_GITHUB_ACCOUNT]/sally-academy-search.git
```

### 2. Install dependencies

```bash
cd sally-academy-search
bun install
```
...
Host your own live version of Sally Academy Search with Vercel, Cloudflare Pages, or Docker.

### Vercel

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FOsama-Qonaibe%2Fsally-academy-search&env=OPENAI_API_KEY,TAVILY_API_KEY,UPSTASH_REDIS_REST_URL,UPSTASH_REDIS_REST_TOKEN)
...
services:
  sally-search:
    image: ghcr.io/osama-qonaibe/sally-academy-search:latest
    env_file: .env.local
    ports:
      - '3000:3000'
    volumes:
